        ...
        <main>
            ...
            <%
                try {
                    ...
                    st = conecta.prepareStatement("SELECT id_checagem, DATE_FORMAT(data_hora, '%d/%m/%Y') AS Data, TIME_FORMAT(data_hora, '%H:%i:%s') AS Hora, situacao AS Situação FROM relatorio ORDER BY id_checagem DESC; ");
